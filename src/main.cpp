...
uint256 hashGenesisBlock("0xfdb8e47985f259fd1355758a156ff3b84ae7d847e04961b0eaf4b734d43ac66d");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 5000000); // Clonecoin: 840k blocks in ~2.5 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3 * 10; // Clonecoin: 30 Seconds.
static const int64 nTargetSpacing = 1 * 10; // Clonecoin: 10 Seconds.
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xfdb8e47985f259fd1355758a156ff3b84ae7d847e04961b0eaf4b734d43ac66d");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "10 Janvier 2019 - Acte 9 des gilets jaunes en vue";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x09f0a43712aef93d131803aff942095f039a17c5dfbe69d133755b1e528e2fb1"));
...
unsigned char pchMessageStart[4] = { 0xc4, 0xd4, 0xd4, 0xb1 }; // Clonecoin: increase each by adding 2 to bitcoin's value.
